...
ScrollPic.prototype = {
  ...
  accountPageIndex : function(){
	...
	if(document.getElementById("pic_num")!=null)
	{
	document.getElementById("pic_num").innerHTML=pageIndex+1+"/"+document.getElementsByClassName("mod_01").length/2
	}
...
var pic=[]
		...
		function init()
		{
			...
			var pic1 = document.getElementsByTagName("img");			
			for(var i=0;i<pic1.length;i++)
			{
				var width1=pic1[i].width; 
				var height1=pic1[i].height;
				pic[i]={width:width1,height:height1};	
				if(w>sizeWidth)
				{
					w=sizeWidth
				}
				pic1[i].width=width1*w/sizeWidth;
				pic1[i].height=height1*w/sizeWidth;
			}
		...
		{	
			...
			windowWidth=(windowWidth>720)?720:windowWidth;
			
			for(var i=0;i<document.getElementsByClassName("mod_01").length;i++)
			{
				document.getElementsByClassName("mod_01")[i].style.width=windowWidth+"px";
			}
			if(document.getElementById("slide_01")){
			  ...
			  slide_01.frameWidth     = windowWidth;
			  slide_01.pageWidth      = windowWidth;
		...
		window.onresize=function(){
			...
			windowWidth=(windowWidth>720)?720:windowWidth;
			document.getElementsByClassName('imageDiv')[0].style.width=windowWidth+"px";
			document.getElementsByClassName('scroll')[0].style.width=windowWidth+"px";
			for(var i=0;i<document.getElementsByClassName("mod_01").length;i++) 
			{
				document.getElementsByClassName("mod_01")[i].style.width=windowWidth+"px";
			}			
